                ...
                <tbody>
                    <tr>
                        ...
                        <td class="text-center">
                            <a class="btn btn-warning" href="ControladorPersona1?accion=editar&idPersona=<%= per.getIdPersona()%>" onclick="return confirmarEdicion()">Editar</a>
                            <a class="btn btn-danger" href="ControladorPersona1?accion=eliminar&idPersona=<%= per.getIdPersona()%>" onclick="return confirmarEliminar()">Remove</a>
                        </td>
                    </tr>
                    <%}%>
                </tbody>
